				...
				command_tests => [
						  {
						   ...
						   read => [ `cat $::config->{core_directory}/tests/specifications/strings/springmass3p.txt`, ],
						   timeout => 8,
						   write => undef,
						  },
						 ],
				...
				command_tests => [
						  {
						   ...
						   read => [ `cat $::config->{core_directory}/tests/specifications/strings/springmass4p.txt`, ],
						   timeout => 8,
						   write => undef,
						  },
						 ],
