				...
				command_tests => [
						  {
						   ...
						   read => [ `cat /local_home/local_home/hugo/neurospaces_project/heccer/source/c/snapshots/0/tests/specifications/strings/singlep.txt`, ],
						   timeout => 5,
						   write => undef,
						  },
						 ],
				...
				command_tests => [
						  {
						   ...
						   read => [ `cat /local_home/local_home/hugo/neurospaces_project/heccer/source/c/snapshots/0/tests/specifications/strings/doublep.txt`, ],
						   timeout => 5,
						   write => undef,
						  },
						 ],
				...
				command_tests => [
						  {
						   ...
						   read => [ `cat /local_home/local_home/hugo/neurospaces_project/heccer/source/c/snapshots/0/tests/specifications/strings/triplep.txt`, ],
						   timeout => 5,
						   write => undef,
						  },
						 ],
				...
				command_tests => [
						  {
						   ...
						   read => [ `cat /local_home/local_home/hugo/neurospaces_project/heccer/source/c/snapshots/0/tests/specifications/strings/fork3p.txt`, ],
						   timeout => 5,
						   write => undef,
						  },
						 ],
				...
				command_tests => [
						  {
						   ...
						   read => [ `cat /local_home/local_home/hugo/neurospaces_project/heccer/source/c/snapshots/0/tests/specifications/strings/fork4p1.txt`, ],
						   timeout => 5,
						   write => undef,
						  },
						 ],
				...
				command_tests => [
						  {
						   ...
						   read => [ `cat /local_home/local_home/hugo/neurospaces_project/heccer/source/c/snapshots/0/tests/specifications/strings/fork4p2.txt`, ],
						   timeout => 5,
						   write => undef,
						  },
						 ],
				...
				command_tests => [
						  {
						   ...
						   read => [ `cat /local_home/local_home/hugo/neurospaces_project/heccer/source/c/snapshots/0/tests/specifications/strings/fork4p3.txt`, ],
						   timeout => 5,
						   write => undef,
						  },
						 ],
				...
				command_tests => [
						  {
						   ...
						   read => [ `cat /local_home/local_home/hugo/neurospaces_project/heccer/source/c/snapshots/0/tests/specifications/strings/c1c2p1.txt`, ],
						   timeout => 5,
						   write => undef,
						  },
						 ],
				...
				command_tests => [
						  {
						   ...
						   read => [ `cat /local_home/local_home/hugo/neurospaces_project/heccer/source/c/snapshots/0/tests/specifications/strings/c1c2p2.txt`, ],
						   timeout => 5,
						   write => undef,
						  },
						 ],
				...
				command_tests => [
						  {
						   ...
						   read => [ `cat /local_home/local_home/hugo/neurospaces_project/ssp/source/perl/snapshots/0/tests/specifications/strings/tensizesp.txt`, ],
						   timeout => 18,
						   write => undef,
						  },
						 ],
